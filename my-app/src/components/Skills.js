    ...
    <section id="skills" className="">
      <div className="container px-5 py-10 mx-auto md:w-3/4 lg:w-full">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-y-6 justify-center items-center">
          {skills.map((skill, id) => (
            <div class="flex flex-col justify-center items-center m-auto w-5/6 h-auto font-extralight bg-white border border-gray-200 rounded-lg shadow">
              ...
              <h5 class="mb-2  w-full text-center tracking-tight 	text-gray-900">
                {skill.name}
              </h5>
            </div>
          ))}
